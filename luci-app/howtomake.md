...
```
curl -LO https://immortalwrt.kyarucloud.moe/releases/24.10.5/targets/x86/64/immortalwrt-sdk-24.10.5-x86-64_gcc-13.3.0_musl.Linux-x86_64.tar.zst
Uhh... immortalwrt.kyarucloud.moe domain maybe bad gateway
